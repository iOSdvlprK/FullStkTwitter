...
public class RequestServices {
    ...
    static func fetchData(completion: @escaping (Result<Data?, NetworkError>) -> Void) {
        let url = URL(string: requestDomain)!
        let session = URLSession.shared
    ...
    public static func followingProcess(id: String, completion: @escaping ([String: Any]?) -> Void) {
        let url = URL(string: requestDomain)!
        let session = URLSession.shared
    ...
    public static func likeTweet(id: String, completion: @escaping ([String: Any]?) -> Void) {
        let url = URL(string: requestDomain)!
        let session = URLSession.shared
    ...
    public static func sendNotification(username: String, notSenderId: String, notReceiverId: String, notificationType: String, postText: String, completion: @escaping ([String: Any]?) -> Void) {
